...
> The marketplace is in [`brand-ai-readiness-audit/`](brand-ai-readiness-audit/). Every command in this
> README runs from that folder.

```bash
git clone https://github.com/Sheel23501/citable-brand-ai-readiness-audit.git
cd citable-brand-ai-readiness-audit/brand-ai-readiness-audit
...
seconds, and a complete real report in [`examples/`](brand-ai-readiness-audit/examples/).
...
A finished report from a real run is in [`examples/`](brand-ai-readiness-audit/examples/) — 10 findings
...
tests/
  run_tests.py            4765 assertions across 29 synthetic fixture sites
...
checks that must record no verdict on it and why. [`CONTRIBUTING.md`](brand-ai-readiness-audit/CONTRIBUTING.md) has the
full category and language matrix.

## Working on this

[`CONTRIBUTING.md`](brand-ai-readiness-audit/CONTRIBUTING.md) covers what a new contributor needs: the fast per-stage test
...
MIT. See [`LICENSE`](brand-ai-readiness-audit/LICENSE).
